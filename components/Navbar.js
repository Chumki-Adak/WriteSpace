            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    <div className='flex items-center'>
                        <Button className="mx-1" variant="outline"><Link href="/login">Login</Link></Button>
                        <Button className="mx-1" variant="outline"><Link href="/register">Register</Link></Button>
                        <ModeToggle />
                    </div>
                </div>
                ...
                <div className="md:hidden">
                    ...
                    <Sheet>
                        ...
                        <SheetContent>
                            <SheetHeader>
                                <SheetTitle className="font-bold my-4">AI Blog</SheetTitle>
                                <SheetDescription>
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div>
                                            <Button className="mx-1 text-xs" variant="outline"><Link href="/login">Login</Link></Button>
                                            <Button className="mx-1 text-xs" variant="outline"><Link href="/register">Register</Link></Button>
